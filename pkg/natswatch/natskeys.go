...
// GTEventsSubjectVersion is the wire protocol version for GT_EVENTS and
// GT_INTERNAL subjects. The Go module may be /v2; this version governs the
// NATS subject namespace only.
...
const (
	...
	GTDetectorBooted    = GTEventsPrefix + ".detector.booted"
)
