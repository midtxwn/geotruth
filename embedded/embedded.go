...
// Dependencies contains caller-provided dependencies for the all-in-one local
// stack. RunLocalStack owns the embedded NATS server and injects service
...
// RunLocalStack starts an embedded NATS server plus GeoTruth. It is intended
// for local development, integration tests, and debug tooling. Production
// integrations should call RunGeoTruth with their own NATS connector and
// region resolver.
func RunLocalStack(ctx context.Context, cfg Config, deps Dependencies) (*Services, error) {
