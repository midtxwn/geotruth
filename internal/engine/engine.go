...
func (e *Engine) snapshotObjectState(id string, ctl *ObjCtl, instanceID string, commitSeq uint64) gtevents.ObjectStateRecord {
...
func (e *Engine) BootstrapFromState(state *gtevents.ObjectStateRecord) {
	...
	ctl.instanceID = state.InstanceID
	ctl.lastCommitSeq = state.CommitSeq
