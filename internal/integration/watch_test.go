...
func TestWatch_ObjectRegistered(t *testing.T) {
	...
	if err := pub.RegisterObject(ctx, "watch-obj1", dims); err != nil {
...
func TestWatch_PositionUpdates(t *testing.T) {
	...
	if err := pub.RegisterObject(ctx, "watch-pos-obj1", dims); err != nil {
		t.Fatalf("RegisterObject: %v", err)
	}

	if err := pub.UpdateObjectPosition(ctx, "watch-pos-obj1", 5.0, 5.0, 1.0, 0.0); err != nil {
...
func TestWatch_GeofenceTransitions(t *testing.T) {
	...
	dims := domain.ObjectDimensions{Width: 1.0, Height: 1.0}
	if err := pub.RegisterObject(ctx, "gf-obj1", dims); err != nil {
		t.Fatalf("RegisterObject: %v", err)
	}

	if err := pub.UpdateObjectPosition(ctx, "gf-obj1", 5.0, 5.0, 1.0, 0.0); err != nil {
		t.Fatalf("UpdateObjectPosition: %v", err)
	}
...
func TestWatch_ClientOpIDPropagatesThroughObjectEvents(t *testing.T) {
	...
	requestObjectCommand(t, ctx, nc, natspublish.IngesterRegisterObjectSubject("client-op-obj1"), natspublish.RegisterObjectReq{
		ID:         "client-op-obj1",
		Dims:       domain.ObjectDimensions{Width: 1.0, Height: 1.0},
		ClientOpID: "op-register",
	})
	requestObjectCommand(t, ctx, nc, natspublish.IngesterUpdatePositionSubject("client-op-obj1"), natspublish.UpdatePositionReq{
		ID:         "client-op-obj1",
		X:          5.0,
		Y:          5.0,
		Z:          1.0,
	...
	requestObjectCommand(t, ctx, nc, natspublish.IngesterRemoveObjectSubject("client-op-obj1"), natspublish.RemoveObjectReq{
		ID:         "client-op-obj1",
...
func TestWatch_WatchObject(t *testing.T) {
	...
	pub := natspublish.New(nc)
	dims := domain.ObjectDimensions{Width: 1.0, Height: 1.0}
	if err := pub.RegisterObject(ctx, "wo-obj1", dims); err != nil {
		t.Fatalf("RegisterObject: %v", err)
	}
	...
	if err := pub.UpdateObjectPosition(ctx, "wo-obj1", 3.0, 3.0, 1.0, 0.0); err != nil {
		t.Fatalf("UpdateObjectPosition: %v", err)
	}
...
func TestWatch_AllGeofenceTransitions(t *testing.T) {
	...
	dims := domain.ObjectDimensions{Width: 1.0, Height: 1.0}
	if err := pub.RegisterObject(ctx, "all-gf-obj1", dims); err != nil {
		t.Fatalf("RegisterObject: %v", err)
	}

	if err := pub.UpdateObjectPosition(ctx, "all-gf-obj1", 5.0, 5.0, 1.0, 0.0); err != nil {
		t.Fatalf("UpdateObjectPosition: %v", err)
	}
...
func TestWatch_ObjectRemoved(t *testing.T) {
	...
	dims := domain.ObjectDimensions{Width: 1.0, Height: 1.0}
	if err := pub.RegisterObject(ctx, "rm-obj1", dims); err != nil {
		t.Fatalf("RegisterObject: %v", err)
	}
	if err := pub.UpdateObjectPosition(ctx, "rm-obj1", 5.0, 5.0, 1.0, 0.0); err != nil {
		t.Fatalf("UpdateObjectPosition: %v", err)
	}
	...
	if err := pub.RemoveObject(ctx, "rm-obj1"); err != nil {
